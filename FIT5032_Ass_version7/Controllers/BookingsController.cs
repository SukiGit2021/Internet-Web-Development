...
namespace FIT5032_Ass_version7.Controllers
{
    public class BookingsController : Controller
    {
        ...
        [Authorize]
        public ActionResult Create([Bind(Include = "Id,startDate,price,endDate,comment,rating,OrderHide,OrderStatus,OrderDate,AspNetUsersId,HouseId")] Booking booking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,startDate,price,endDate,comment,rating,OrderHide,OrderStatus,OrderDate,AspNetUsersId")] Booking booking)
        {
            if (ModelState.IsValid)
            {
